...
urlpatterns += patterns('website.views',
    ...
    url(r'^politicos/lord/$', 'politicos_overview', {'type': 'LD'}),
    url(r'^politicos/lord/(?P<mp_name>[a-zA-Z_\'-]+)/$', 'politico_detail'),
    url(r'^politicos/mp/$', 'politicos_overview', {'type': 'MP'}),
    url(r'^politicos/mp/(?P<mp_name>[a-zA-Z_\'-]+)/$', 'politico_detail'),
