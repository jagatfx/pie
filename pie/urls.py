...
urlpatterns += patterns('website.views',
    ...
    url(r'^politicos/US/$', 'politicos_overview', {'type': 'US'}),
    url(r'^politicos/UR/$', 'politicos_overview', {'type': 'UR'}),
    url(r'^politicos/LD/(?P<pol_name>[a-zA-Z_\'-]+)/$', 'politico_detail'),
    url(r'^politicos/MP/(?P<pol_name>[a-zA-Z_\'-]+)/$', 'politico_detail'),
    url(r'^politicos/US/(?P<pol_name>[a-zA-Z_\'-]+)/$', 'politico_detail'),
    url(r'^politicos/UR/(?P<pol_name>[a-zA-Z_\'-]+)/$', 'politico_detail'),
